...
namespace LazyE9.DataMock
{
	...
	{
		#region MemberInfoExtensions Members

		public static string GetFullName( this MethodBase method )
		{
			if( method.IsGenericMethod )
			{
				return method.Name + _GetGenericArguments( method.GetGenericArguments(), t => GetFullName( t ) );
			}
		...
		public static string GetFullName( this Type type )
		{
			if( type.IsGenericType )
			{
				return type.FullName.Substring( 0, type.FullName.IndexOf( '`' ) ) +
					_GetGenericArguments( type.GetGenericArguments(), t => GetFullName( t ) );
			}
		...
		public static string GetName( this MethodBase method )
		{
			if( method.IsGenericMethod )
			{
				return method.Name + _GetGenericArguments( method.GetGenericArguments(), t => GetName( t ) );
			}
		...
		public static string GetName( this Type type )
		{
			if( type.IsGenericType )
			{
				return type.Name.Substring( 0, type.Name.IndexOf( '`' ) ) +
					_GetGenericArguments( type.GetGenericArguments(), t => GetName( t ) );
			}
		...
		#endregion MemberInfoExtensions Members

		#region Private Members

		private static string _GetGenericArguments( IEnumerable<Type> types, Func<Type, string> typeGetter )
		{
